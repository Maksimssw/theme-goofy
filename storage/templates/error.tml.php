<?php if (!defined('ABSPATH')) :
    ...
    <head>
        ...
        <title>Error - GeekPress | <?= getOptions('version'); ?></title>
        ...
        <div id="app">
            ...
            <main id="content">
                <div class="wrap" id="activate">
                    <div class="app-block">
                        <div class="row">
                            <h5 class="title">Ошибка загрузки шаблона</h5>
                            <p>Не найден файл <code>index.php</code> в директории шаблона <code><?=$GLOBALS['active_template'];?></code>.</p>
                        </div>
                    </div>
                </div>
            </main>
